    ...
    <section className="relative min-h-screen flex flex-col justify-center px-6 pt-20 pb-20 max-w-5xl mx-auto overflow-hidden">
      ...
      >
        ...
        <motion.div variants={item}>
          <h1 className="text-[clamp(2.8rem,8vw,5rem)] font-bold tracking-tight leading-[1.05] text-zinc-900 dark:text-zinc-50">
            {profile.name}
          </h1>
        ...
        <motion.p
          variants={item}
          className="text-base md:text-lg text-zinc-600 dark:text-zinc-400 leading-relaxed max-w-2xl"
        >
          {p.summary}
        </motion.p>
